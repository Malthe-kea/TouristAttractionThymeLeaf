...
public class TouristAttractionRepository {
    ...
    public void populateAttractionList() {
        attractionList = new ArrayList<>(List.of(
                new TouristAttraction("Rundetårn", "et højt tårn", City.COPENHAGEN, List.of(Tag.ADVENTURE,Tag.AKTIVITET),true),
                new TouristAttraction("Odense Zoo", "Zoologisk have på Fyn", City.ODENSE, List.of(Tag.ARKITEKTUR),true),
                new TouristAttraction("Sønderborg Slot", "Et slot, der ligger på øen Als i Sønderjylland", City.SOENDERBORG, List.of(Tag.ZOOLOGISKHAVE),true),
                new TouristAttraction("Grenen", "grenen i Skagen er det nordligste punkt i Danmark", City.AALBORG, List.of(Tag.RESTAURANT),false),
                new TouristAttraction("Hammershus", "En rundkirke på øen Bornholm", City.COPENHAGEN, List.of(Tag.OPLEVELSESZONER), false),
                new TouristAttraction("Den Gamle By", "En gammel by i Aarhus", City.AARHUS, List.of(Tag.KULTURARV),true)
        ));
    }
